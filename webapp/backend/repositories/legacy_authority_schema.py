...
CREATE TABLE authorization_artifacts (
 ...
 canary_idempotency_key TEXT NOT NULL, canary_run_id TEXT NOT NULL, authority_epoch TEXT NOT NULL, fence_counter INTEGER NOT NULL,
...
CREATE TABLE fences (
 ...
 authority_epoch TEXT NOT NULL, fence_counter INTEGER NOT NULL, state TEXT NOT NULL,
 UNIQUE(authority_epoch, fence_counter)
);
...
CREATE TABLE fence_history (
 ...
 canary_run_id TEXT NOT NULL, authority_epoch TEXT NOT NULL, fence_counter INTEGER NOT NULL,
...
CREATE TABLE receipts (
 ...
 authority_epoch TEXT NOT NULL, fence_counter INTEGER NOT NULL, source_identity_ref TEXT NOT NULL,
 ...
 observation_generation_floor INTEGER NOT NULL, state TEXT NOT NULL,
 observation_boundary_id TEXT, observation_generation INTEGER
);
...
CREATE TRIGGER receipt_lineage_immutable BEFORE UPDATE ON receipts
 ...
 OR NEW.canary_run_id IS NOT OLD.canary_run_id OR NEW.authority_epoch IS NOT OLD.authority_epoch
 ...
 OR NEW.observation_generation_floor IS NOT OLD.observation_generation_floor
